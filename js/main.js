...
//Клик по кнопке для показа/скрытия  фильтра и изменения иконки
...
widgets.forEach(function(widget){
    ...
    widget.addEventListener('click', function (e){
        ...
        // Если клик по заголовку, то показываем/скрываем тело виджета
...
// Клик кнопки Любая и отключение других чекбоксов
...
/* Показать еще 3 доп опции с чекбоксом в фильтре */
